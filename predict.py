...
# Load model and scaler from URLs
...
def predict(smiles_input):
    # Ensure model and scaler are loaded successfully
    if model is None or scaler is None:
        return "Model or scaler failed to load. Unable to make predictions."
    ...
    if molecule:
        ...
        return f"Prediction Outcome: **{outcome}**"
    else:
...
# print(predictions)  # or do whatever you want with the predictions
